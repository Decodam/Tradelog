        ...
        <div id='container'>
            <div id="sidebar">
                ...
                <div className="nav_list">
                    <div className="nav_item"><AiFillHome className='nav_icon'/></div>
                    <div className="nav_item"><AiFillDatabase className='nav_icon'/></div>
                    <div className="nav_item"><AiFillCalculator className='nav_icon'/></div>
                    <div className="nav_item"><AiFillSetting className='nav_icon'/></div>
                </div>


                <img className='nav_acc' src="https://randomuser.me/api/portraits/women/44.jpg" alt="" />
            </div>
            <div id="content">
